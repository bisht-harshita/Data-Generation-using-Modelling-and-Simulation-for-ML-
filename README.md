...
Trees & Ensembles: Decision Tree, Random Forest, Gradient Boosting, XGBoost, AdaBoost
Other: Support Vector Regressor (SVR), K-Nearest Neighbors (KNN)
Evaluation Metric: R2 Score (Coefficient of Determination) and RMSE.
Results
